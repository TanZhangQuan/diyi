...
public interface IUserClient {
    ...
    R findRunCompanyMakerId(@RequestBody Query query, @RequestParam("makerId") Long makerId);
    ...
    R findMakerNamePage(@RequestBody Query query, @RequestParam("name") String name);
