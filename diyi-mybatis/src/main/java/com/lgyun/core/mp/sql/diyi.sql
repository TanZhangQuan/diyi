...
CREATE TABLE `diyi_agreement` (
  ...
  `start_date_time` datetime DEFAULT NULL COMMENT '在线协议发起时间',
  ...
  `poaplatform_sign_date_time` datetime DEFAULT NULL COMMENT '平台在线协议平台方操作日期',
  `poamaker_sign_date_time` datetime DEFAULT NULL COMMENT '平台在线协议分包方操作日期',
  `poacompany_sign_date_time` datetime DEFAULT NULL COMMENT '平台在线协议发包方操作日期',
