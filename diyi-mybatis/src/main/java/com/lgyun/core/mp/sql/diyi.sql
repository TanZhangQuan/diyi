...
CREATE TABLE `diyi_maker` (
  ...
  `phone_number` varchar(100) NOT NULL DEFAULT '' COMMENT '手机号码',
  `phone_number2` varchar(100) NOT NULL DEFAULT '' COMMENT '手机号码2',
  ...
  `idcard_verify_status` varchar(50) NOT NULL COMMENT '身份验证状态：未验证，验证通过，验证未通过',
  `idcard_verify_date` datetime DEFAULT NULL COMMENT '验证日期时间',
