package com.lgyun.common.swagger;
...
public class SwaggerDisplayConfig implements ModelPropertyBuilderPlugin {
    ...
    private void descForEnumFields(ModelPropertyContext context, Class fieldType) {
        ...
        final List<String> displayValues = Arrays.stream(subItemRecords).filter(Objects::nonNull).map(Object::toString).filter(Objects::nonNull).collect(Collectors.toList());
