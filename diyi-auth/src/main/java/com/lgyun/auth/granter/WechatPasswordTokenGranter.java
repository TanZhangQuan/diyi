...
@Component
@AllArgsConstructor
public class WechatPasswordTokenGranter implements ITokenGranter {
    private static Logger logger = LoggerFactory.getLogger(WechatPasswordTokenGranter.class);

    public static final String GRANT_TYPE = "wechat_password";
    ...
    public UserInfo grant(TokenParameter tokenParameter) {
        ...
        try {
            ...
            User user = userClient.wechatPassword(account, DigestUtil.encrypt(password), openid, sessionKey);
