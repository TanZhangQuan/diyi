...
public class SelfHelpInvoiceEnterpriseController {
    ...
    public R queryCooperationServiceProviderList(Query query, BladeUser bladeUser) {
        //查询当前商户员工
        ...
        return enterpriseServiceProviderService.queryCooperationServiceProviderList(enterpriseWorkerEntity.getEnterpriseId(),null,Condition.getPage(query.setDescs("t1.create_time")));
    }
