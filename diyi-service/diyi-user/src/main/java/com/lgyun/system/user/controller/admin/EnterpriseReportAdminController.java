...
public class EnterpriseReportAdminController {
    ...
    public R findAdminEnterpriseReportAll(@ApiParam(value = "服务商名字") @RequestParam(required = false) String serviceProviderName,
                                          ...
                                          String startTime, String endTime, Query query) {
    ...
    public R findAdminEnterpriseReport(Long serviceProviderId, ReportTheme reportTheme, Query query) {
    ...
    public R saveAdminEnterpriseReport(@Valid @RequestBody AdminEnterpriseReportDTO adminEnterpriseReportDTO) {
    ...
    public R toExamineAdminEnterpriseReport(Long enterpriseReportId, @ApiParam("1审核通过，2审核不通过") Integer toExamine) {
