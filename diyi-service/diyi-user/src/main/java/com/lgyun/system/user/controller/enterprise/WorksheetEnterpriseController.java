...
public class WorksheetEnterpriseController {
    ...
    public R queryMakerList(@ApiParam(value = "创客姓名") @RequestParam(required = false) String makerName, Query query, BladeUser bladeUser) {
        //查询当前商户员工
        ...
        return makerService.queryWorkMakerList(enterpriseWorkerEntity.getEnterpriseId(), makerName, Condition.getPage(query));
    }
