...
public class InvoiceAdminController {
    ...
    public R getAdminLumpSumInvoice(@RequestParam(required = false) String enterpriseName,
                                    ...
                                    @RequestParam InvoiceState companyInvoiceState, Query query) {
    ...
    public R getAdminLumpSumInvoiceDetails(Long payEnterpriseId) {
    ...
    public R saveAdminLumpSumInvoice(Long payEnterpriseId, Long applicationId, String companyInvoiceUrl, String expressSheetNo, String expressCompanyName, String invoiceDesc) {
    ...
    public R getSubcontractInvoice(@RequestParam(required = false) String enterpriseName,
                                   @RequestParam(required = false) String startTime,
                                   @RequestParam(required = false) String endTime, Query query) {
    ...
    public R getSubcontractInvoice(@ApiParam(value = "商户支付清单Id") @NotNull(message = "请输入商户支付清单Id") @RequestParam(required = false) Long payEnterpriseId) {
    ...
    public R applySummaryInvoice(@ApiParam(value = "商户支付清单Id") @NotNull(message = "请输入商户支付清单Id") @RequestParam(required = false) Long payEnterpriseId) {
        return payEnterpriseService.getSubcontractInvoiceDetails(payEnterpriseId);
    }
    ...
    public R applyPortalSignInvoice(@ApiParam(value = "商户支付清单Id") @NotNull(message = "请输入商户支付清单Id") @RequestParam(required = false) Long payEnterpriseId) {
    ...
    public R savePortalSignInvoice(@ApiParam(value = "商户支付清单Id") @NotNull(message = "请输入商户支付清单Id") @RequestParam(required = false) Long payEnterpriseId,
    ...
    public R getSummaryInvoice(@RequestParam(required = false) String enterpriseName,
                               @RequestParam(required = false) String startTime,
                               @RequestParam(required = false) String endTime, Query query) {
    ...
    public R getSummaryInvoiceDetails(@ApiParam(value = "商户支付清单Id") @NotNull(message = "请输入商户支付清单Id") @RequestParam(required = false) Long payEnterpriseId) {
    ...
    public R getPortalSignInvoice(@RequestParam(required = false) String enterpriseName,
                                  @RequestParam(required = false) String startTime,
                                  @RequestParam(required = false) String endTime, Query query) {
    ...
    public R getPortalSignInvoiceDetails(@ApiParam(value = "商户支付清单Id") @NotNull(message = "请输入商户支付清单Id") @RequestParam(required = false) Long payEnterpriseId) {
    ...
    public R getServiceCrowdSour(@RequestParam(required = false) String enterpriseName,
                                 @RequestParam(required = false) String startTime,
                                 @RequestParam(required = false) String endTime,
                                 SelfHelpInvoiceSpApplyState selfHelpInvoiceSpApplyState, Query query) {
    ...
    public R savePortalSignInvoice(Long providerSelfHelpInvoiceId, String expressNo, String expressCompanyName, String invoiceScanPictures, String taxScanPictures) {
