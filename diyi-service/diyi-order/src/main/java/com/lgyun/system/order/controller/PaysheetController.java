...
public class PaysheetController {
	...
	public R detail(PaysheetEntity paysheet) {
	...
	public R list(PaysheetEntity paysheet, Query query) {
		IPage<PaysheetEntity> pages = paysheetService.page(Condition.getPage(query.setDescs("create_time")), Condition.getQueryWrapper(paysheet));
